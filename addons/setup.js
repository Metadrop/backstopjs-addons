module.exports = async (page, scenario, config) => {
  ...
  if (scenario.stopAnimationsSelectors) {
    ...
    await page.evaluate(async(scenario) => {
      ...
      const css = scenarioSelector + '{animation-duration: 0ms !important; animation-fill-mode: forwards !important; animation-iteration-count: 1 !important; animation-delay: 0ms !important; transition-duration: 0ms !important; transition: none !important; visibility: visible !important;}';
