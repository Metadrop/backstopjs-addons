module.exports = async (page, scenario, config) => {
  ...
  if (scenario.stopAnimationsSelectors) {
    ...
    await page.evaluate(async(scenario) => {
      ...
      const css = scenarioSelector + '{animation-duration: 0ms !important; animation-fill-mode: backwards !important; animation: none !important; transition-duration: 0ms !important; transition: none !important; visibility: visible !important;}';
